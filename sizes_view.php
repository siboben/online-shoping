...
<div id="body">
        ...
        echo "<h3 style = 'float: left; font-family: georgia'>Welcome " . $_SESSION['username'] . "</h3>";
          ?>  <a href ="user_logout.php" style ="float: right;padding: 20px 20px;">Logout</a><br />
            ...
            <h3 style = 'float: center; font-family: georgia'>List of registered Sizes</h3>
            <?php
          include 'connect.php';
          $quer = "select * from size";
          $query = mysql_query($quer);
            ?>
            <table border ="1" align ="center" style="border-collapse: collapse">
                <tr>
                    <th style="border: 2px solid blue">No</th>
                    <th style="border: 2px solid blue">Size Name</th>
                    <th style="border: 2px solid blue">Function</th>
                </tr>
                <?php
                $count = 1;
                ...
                <tr>
                    ...
                    <td style="border: 2px solid blue"><?php echo $row['size_name']; ?></td>
                    <td style="border: 2px solid blue">
                        <a href ="size_delete.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Do you really want to delete this record?')"><img src ="delete.png" width="15">Delete</a>
                    </td>
