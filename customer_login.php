...
<?php
    ...
    ?>
<div id="body">
<h1>Welcome to Customer Login Form</h1>
            ...
            ?>
<br /><br />
<form method="POST" action="customer_log.php" name="Form" onsubmit="return validateForm()">
            ...
            <?php
                ...
                echo "<font color = 'yellow' face = 'georgia'>Please, Login as registered customer!!!</font>";
            }
            ?>
</div>
<?php
