...
<?php
    ...
    ?>
<div id="body">            
<h1>Welcome to Administrator Login Form</h1>
            ...
            ?>
<form method="POST" action="admin.php" name="Form" onsubmit="return validateForm()">
            ...
            <?php
                ...
                echo "<font color = 'yellow' face = 'georgia'>Please, Login as Administrator!!!</font>";
            }
            ?>
</div>
<?php
