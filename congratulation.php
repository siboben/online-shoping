...
<p style = 'float: left; font-family: georgia;font-style: italic;padding-left: 10px'>
        If the entered information contains some errors, please  <a href="customer_edit.php">Edit</a></p><br />
<p style = 'float: left; font-family: georgia;font-style: italic'>Please <a href="customer_login.php">Login</a> to purchase the selected cloth(es)</p>
